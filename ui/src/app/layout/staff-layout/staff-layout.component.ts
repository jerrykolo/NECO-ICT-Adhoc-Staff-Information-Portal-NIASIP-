...
@Component({
    ...
    <div class="staff-layout">
      <aside class="sidebar" [class.open]="sidebarOpen">
        ...
        <nav class="sidebar-nav">
          <a routerLink="/staff/dashboard" routerLinkActive="active" class="nav-item" (click)="sidebarOpen = false">
            <i class="pi pi-home"></i>
            <span>Dashboard</span>
          </a>
          <a routerLink="/staff/profile" routerLinkActive="active" class="nav-item" (click)="sidebarOpen = false">
            <i class="pi pi-user"></i>
            <span>My Profile</span>
          </a>
          <a routerLink="/staff/bank-details" routerLinkActive="active" class="nav-item" (click)="sidebarOpen = false">
      ...
      <div class="main-area" [class.sidebar-open]="sidebarOpen">
        <header class="top-header">
          ...
          <div class="user-dropdown" *ngIf="showUserMenu">
            <a routerLink="/staff/profile" (click)="showUserMenu = false">
  ...
  `,
  styles: [`
    .staff-layout { display: flex; min-height: 100vh; background: #F4F5F5; }
    .sidebar {
    ...
    .sidebar-header {
      ...
      padding: 20px 20px; border-bottom: 1px solid rgba(255,255,255,0.1);
    }
    .sidebar-logo {
    ...
    .user-avatar {
      width: 36px; height: 36px; background: #1D7A43; color: white;
    ...
    .user-dropdown a, .user-dropdown button {
      ...
      color: #2F3B52; text-decoration: none; border: none; background: none;
      width: 100%; font-size: 0.88rem; border-radius: 8px; cursor: pointer;
    }
    .user-dropdown a:hover, .user-dropdown button:hover { background: #f3f4f6; }
...
export class StaffLayoutComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    if (user) {
      ...
      this.userInitials = names.map(n => n[0]).join('').substring(0, 2).toUpperCase();
    }
  }
